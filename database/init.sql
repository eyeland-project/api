...
CREATE TYPE valid_task_stage_mechanic AS ENUM ('question_group-team_name');
...
CREATE TABLE question_group (
    ...
    CONSTRAINT fk_question_group_task_stage FOREIGN KEY (id_task_stage) REFERENCES task_stage(id_task_stage),
    CONSTRAINT fk_question_group_team_name FOREIGN KEY (id_team_name) REFERENCES team_name(id_team_name)
);

-- -- CREATING TABLE question_group_assignment
-- CREATE TABLE question_group_assignment (
--     id_question_group_assignment SERIAL NOT NULL,
--     id_question_group INTEGER NOT NULL,
--     id_team INTEGER,
--     id_student INTEGER,
--     -- CONSTRAINTS
--     CONSTRAINT pk_question_group_assignment PRIMARY KEY (id_question_group_assignment),
--     CONSTRAINT fk_question_group_assignment_question_group FOREIGN KEY (id_question_group) REFERENCES question_group(id_question_group),
--     CONSTRAINT fk_question_group_assignment_team FOREIGN KEY (id_team) REFERENCES team(id_team),
--     CONSTRAINT fk_question_group_assignment_student FOREIGN KEY (id_student) REFERENCES student(id_student)
-- );
...
CREATE TABLE question (
    ...
    id_question_group SMALLINT NOT NULL,
    -- id_task_stage SMALLINT NOT NULL,
...
BEGIN
    ...
    -- pretask 1
    INSERT INTO question_group (id_task_stage) VALUES (1) RETURNING id_question_group INTO last_question_group_id;
    
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 1, 'Describe la imagen', NULL, NULL, 'select', 'Imagen de un camino', 'https://storage.googleapis.com/eyeland-0/app/content/task_1/road_2.jpg', 'vocabulary', NULL, 'La imagen muestra un camino.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 2, 'Describe la imagen', NULL, NULL, 'select', 'Imagen de un parque natural', 'https://storage.googleapis.com/eyeland-0/app/content/task_1/natural_park_2.jpg', 'vocabulary', NULL, 'La imagen muestra un parque natural.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 3, 'Bridge', NULL, NULL, 'audio_select', 'Imagen de un puente', 'https://storage.googleapis.com/eyeland-0/app/content/task_1/bridge_1.jpg', 'vocabulary', NULL, 'La imagen muestra un puente.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 5, 'Describe la imagen', NULL, NULL, 'select', 'Imagen de un manglar', 'https://storage.googleapis.com/eyeland-0/app/content/task_1/mangrove_1.jpg', 'vocabulary', NULL, 'La imagen muestra un manglar.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 7, 'Describe la imagen', NULL, NULL, 'select', 'Imagen de un pantano', 'https://storage.googleapis.com/eyeland-0/app/content/task_1/swamp_1.jpg', 'vocabulary', NULL, 'La imagen muestra un pantano.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 8, 'El camino está entre Barranquilla y el parque natural', NULL, NULL, 'order', 'Imagen de un camino entre Barranquilla e Isla Salamanca', 'https://storage.googleapis.com/eyeland-0/app/content/task_1/road_1.jpg', 'prepositions', NULL, 'La imagen muestra un camino entre Barranquilla e Isla Salamanca.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 9, 'Describe la imagen', NULL, NULL, 'select', 'Imagen de un bote', 'https://storage.googleapis.com/eyeland-0/app/content/task_1/boat_1.jpg', 'vocabulary', NULL, 'La imagen muestra un bote.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 10, 'The bridge is over the water', NULL, NULL, 'audio_order', 'Imagen de un puente sobre el agua', 'https://storage.googleapis.com/eyeland-0/app/content/task_1/bridge_river_1.jpg', 'prepositions', NULL, 'La imagen muestra un puente sobre el agua.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 11, 'The natural park is near Barranquilla', NULL, NULL, 'audio_speaking', 'Imagen de un parque natural cerca de Barranquilla', 'https://storage.googleapis.com/eyeland-0/app/content/task_1/road_1.jpg', 'prepositions', NULL, 'La imagen muestra un parque natural cerca de Barranquilla.') RETURNING id_question INTO last_question_id;

    -- duringtask 1
    INSERT INTO question_group (id_task_stage) VALUES (2) RETURNING id_question_group INTO last_question_group_id;
    
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 1, 'Bienvenidos, ¡yo seré su guía turístico! Les estaré haciendo unas preguntas durante el recorrido.\Are you [on|sobre] the {bridge|puente}?', NULL, NULL, 'select', 'Imagen de personas sobre un puente', 'https://storage.googleapis.com/eyeland-0/app/content/task_1/bridge_1.jpg', NULL, 'beto', 'La imagen muestra personas sobre un puente.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 2, '¡Espero que estén disfrutando del recorrido! Ahora, miren el puente.\Is there a {river|río} [under|debajo] the {bridge|puente}?', NULL, NULL, 'select', 'Imagen de un río bajo un puente', 'https://storage.googleapis.com/eyeland-0/app/content/task_1/bridge_river_1.jpg', NULL, 'beto', 'La imagen muestra un río bajo un puente.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 3, '¡Qué emoción! Cerca se puede ver el pueblo de Palermo.\Look at the {road|camino}. Is there a {town|pueblo} [near|cerca de] it?', NULL, NULL, 'select', 'Imagen de un pueblo cerca de un camino', 'https://storage.googleapis.com/eyeland-0/app/content/task_1/town_road_1.jpg', NULL, 'beto', 'La imagen muestra un pueblo cerca de un camino.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 6, 'El paisaje aquí es fascinante.\Are there {swamps|pantanos} [near|cerca de] the {beach|playa}?', NULL, NULL, 'select', 'Imagen de una playa con pantanos cerca', 'https://storage.googleapis.com/eyeland-0/app/content/task_1/beach_swamps_1.jpg', NULL, 'beto', 'La imagen muestra una playa con pantanos cerca.') RETURNING id_question INTO last_question_id;
    ...
    -- postask 1
    INSERT INTO question_group (id_task_stage) VALUES (3) RETURNING id_question_group INTO last_question_group_id;

    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 1, '¡Hemos llegado al final! Revisemos lo aprendido con unas preguntas. Are there boats next to the road?', NULL, NULL, 'select&speaking', NULL, NULL, NULL, 'beto', NULL) RETURNING id_question INTO last_question_id;
    INSERT INTO option (id_question, content, feedback, correct) VALUES (last_question_id, 'Yes, there are.', 'Correct', TRUE);
    INSERT INTO option (id_question, content, feedback, correct) VALUES (last_question_id, 'No, there aren''t.', 'Incorrect', FALSE);

    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 2, 'What is there over the river?', NULL, NULL, 'select&speaking', NULL, NULL, NULL, 'beto', NULL) RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 3, 'What was part of the road?', NULL, NULL, 'select&speaking', NULL, NULL, NULL, 'beto', NULL) RETURNING id_question INTO last_question_id;
    ...
    -- pretask 2
    INSERT INTO question_group (id_task_stage) VALUES (4) RETURNING id_question_group INTO last_question_group_id;

    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 1, '¿Cuál es el animal de la imagen?', NULL, NULL, 'flashcard', 'Imagen de una gaviota.', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/seagull_1.jpg', 'vocabulary', NULL, NULL) RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 2, '¿Cuál es el animal de la imagen?', NULL, NULL, 'flashcard', 'Imagen de un caimán', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/alligator_1.jpg', 'vocabulary', NULL, NULL) RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 3, '¿Cuál es el animal de la imagen?', NULL, NULL, 'flashcard', 'Imagen de un ocelote', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/ocelot_1.jpg', 'vocabulary', NULL, NULL) RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 4, '¿Cuál es el animal de la imagen?', NULL, NULL, 'flashcard', 'Imagen de un zorrochucho', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/common_opossum_1.jpg', 'vocabulary', NULL, NULL) RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 5, '¿Cuál es el hábitat de un águila pescadora?', NULL, NULL, 'select', 'Imagen de un águila pescadora', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/osprey_1.jpg', 'vocabulary', NULL, NULL) RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 6, 'Alligator', NULL, NULL, 'audio_order-word', 'Imagen de un caimán', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/alligator_1.jpg', 'vocabulary', NULL, NULL) RETURNING id_question INTO last_question_id;
    INSERT INTO option (id_question, content, feedback, correct) VALUES (last_question_id, 'Alligator', 'Correct', TRUE);

    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 7, '¿Cuál es el animal de la imagen?', NULL, NULL, 'flashcard', 'Imagen de un manatí', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/manatee_1.jpg', 'vocabulary', NULL, NULL) RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 8, '¿Cuál es el hábitat de un róbalo?', NULL, NULL, 'select', 'Imagen de un róbalo bajo el agua', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/seabass_1.jpg', 'vocabulary', NULL, NULL) RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 9, '¿Qué se dice al encontrarse con alguien por primera vez?', NULL, NULL, 'select', 'Imagen de personas conociéndose', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/personal_presentation_1.jpg', 'personal_presentation', NULL, NULL) RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 10, '¿Cómo se pregunta a alguien de dónde es?', NULL, NULL, 'select', 'Imagen de una persona preguntando a otra de dónde es', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/personal_presentation_2.jpg', 'personal_presentation', NULL, NULL) RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 11, 'Tengo 14 años', NULL, NULL, 'order', 'Imagen de una persona diciendo su edad', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/personal_presentation_3.jpg', 'personal_presentation', NULL, NULL) RETURNING id_question INTO last_question_id;
    INSERT INTO option (id_question, content, feedback, correct) VALUES (last_question_id, 'I am 14 years old', 'Correct', TRUE);

    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 12, 'I''m from Colombia', NULL, NULL, 'audio_speaking', 'Imagen de una persona diciendo que es de Colombia', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/personal_presentation_4.jpg', 'personal_presentation', NULL, NULL) RETURNING id_question INTO last_question_id;

    -- duringtask 2
    INSERT INTO question_group (id_task_stage) VALUES (5) RETURNING id_question_group INTO last_question_group_id;

    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 1, '¡Gusto en conocerlos! Me llamo Valery y yo los ayudaré a conocer los animales y a presentarse. Estamos frente a un ocelote.\The {ocelot|ocelote} likes to move [among|entre] {trees|árboles}. What do you like to do?', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/ocelot_1.mp3', NULL, 'select', 'Imagen de un ocelote en un árbol', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/ocelot_tree_1.jpg', NULL, 'valery', NULL) RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 7, 'Shhh, pueden espantar a la gaviota.\The {seagull|gaviota} eats {fish|pescado} [from|de] the {river|río}. Do you eat {fish|pescado}?', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/seagull_1.mp3', NULL, 'select', 'Imagen de una gaviota', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/seagull_fish_1.jpg', NULL, 'valery', NULL) RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 8, '¡Miren ese róbalo saltando en el agua!\The {sea bass|robalo} jumps [out of|fuera de] the {water|agua}. Can you jump high?', NULL, NULL, 'select', 'Imagen de un robalo saltando', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/seabass_2.jpg', NULL, 'valery', NULL) RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 10, '¡No se asusten del lagarto!\The {lizard|lagarto} likes the {sun|sol} [on top of|encima de] the {rocks|rocas}. How do you feel in the {sun|sol}?', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/lizard_1.mp3', NULL, 'select', 'Imagen de un lagarto', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/lizard_rocks_1.jpg', NULL, 'valery', NULL) RETURNING id_question INTO last_question_id;
    ...
    -- postask 2
    INSERT INTO question_group (id_task_stage) VALUES (6) RETURNING id_question_group INTO last_question_group_id;

    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 1, '!Hola! Soy el zorro Chucho y te haré unas preguntas. Can you present yourself in english?', NULL, NULL, 'open', NULL, NULL, NULL, 'chucho', 'My name is _, I''m _ years old, I''m from _ and I like _') RETURNING id_question INTO last_question_id;
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 2, '¡Bien hecho! Última pregunta: what''s your favorite animal from Isla Salamanca?', NULL, NULL, 'open', NULL, NULL, NULL, 'chucho', 'My favorite animal is _') RETURNING id_question INTO last_question_id;
    
    -- questions from task 3
    UPDATE task_stage SET mechanics = '{"question_group-team_name"}';
    
    -- pretask 3
    INSERT INTO question_group (id_task_stage) VALUES (7) RETURNING id_question_group INTO last_question_group_id;

    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 1, 'Select the habitat', NULL, NULL, 'select', 'Imagen de un pantano', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/swamp_1.jpg', 'vocabulary', NULL, 'La imagen muestra un pantano.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 2, 'Select the name', NULL, NULL, 'select', 'Imagen de un águila pescadora', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/osprey_1.jpg', 'vocabulary', NULL, 'La imagen muestra un águila pescadora.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 4, 'Select the body part', NULL, NULL, 'select', 'Imagen de la cola de un lagarto', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/lizard_tail_1.jpg', 'vocabulary', NULL, 'La imagen muestra la cola de un lagarto.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 5, 'Select the skills', NULL, NULL, 'select', 'Imagen de un pato mostrando sus habilidades para nadar', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/duck_swim_1.jpg', 'vocabulary', NULL, 'La imagen muestra un pato nadando.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 6, 'Select the diet', NULL, NULL, 'select', 'Imagen de una gaviota pescando', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/seagull_fish_1.jpg', 'vocabulary', NULL, 'La imagen muestra una gaviota pescando.') RETURNING id_question INTO last_question_id;
    ...
    -- duringtask 3
    INSERT INTO question_group (id_task_stage, id_team_name) VALUES (8, 1) RETURNING id_question_group INTO last_question_group_id;

    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 1, 'Where do ospreys live?', NULL, NULL, 'select', 'Imagen de un águila pescadora en un manglar', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/osprey_mangrove_1.jpg', NULL, NULL, 'La imagen muestra un águila pescadora en un manglar.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 2, 'What''s the osprey''s name?', NULL, NULL, 'select', 'Imagen de un águila pescadora llamada Otto', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/osprey_1.jpg', NULL, NULL, 'La imagen muestra un águila pescadora llamada Otto.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 3, 'How old is the osprey?', NULL, NULL, 'select', 'Imagen de un águila pescadora de 7 años', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/osprey_7yo_1.jpg', NULL, NULL, 'La imagen muestra un águila pescadora de 7 años.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 4, 'Select the body part of the osprey', NULL, NULL, 'select', 'Imagen del ala de un águila pescadora', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/osprey_wing_1.jpg', NULL, NULL, 'La imagen muestra el ala de un águila pescadora.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 5, 'Select the skill of the osprey', NULL, NULL, 'select', 'Imagen de un águila pescadora volando', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/osprey_fly_1.jpg', NULL, NULL, 'La imagen muestra un águila pescadora volando.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 6, 'Select the diet of the osprey', NULL, NULL, 'select', 'Imagen de un águila pescadora pescando', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/osprey_fish_1.jpg', NULL, NULL, 'La imagen muestra un águila pescadora pescando.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question_group (id_task_stage, id_team_name) VALUES (8, 2) RETURNING id_question_group INTO last_question_group_id;
    
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 1, 'Where do lizards live?', NULL, NULL, 'select', 'Imagen de un lagarto en un pantano', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/lizard_swamp_1.jpg', NULL, NULL, 'La imagen muestra un lagarto en un pantano.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 2, 'What''s the lizard''s name?', NULL, NULL, 'select', 'Imagen de una lagarto llamada Lina', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/lizard_1.jpg', NULL, NULL, 'La imagen muestra una lagarto llamada Lina.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 3, 'How old is the lizard?', NULL, NULL, 'select', 'Imagen de un lagarto de 11 años', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/lizard_11yo_1.jpg', NULL, NULL, 'La imagen muestra un lagarto de 11 años.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 4, 'Select the body part of the lizard', NULL, NULL, 'select', 'Imagen de la cola de un lagarto', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/lizard_tail_1.jpg', NULL, NULL, 'La imagen muestra la cola de un lagarto.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 5, 'Select the skill of the lizard', NULL, NULL, 'select', 'Imagen de un lagarto corriendo', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/lizard_run_1.jpg', NULL, NULL, 'La imagen muestra un lagarto corriendo.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 6, 'Select the diet of the lizard', NULL, NULL, 'select', 'Imagen de un lagarto comiendo', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/lizard_eat_1.jpg', NULL, NULL, 'La imagen muestra un lagarto comiendo.') RETURNING id_question INTO last_question_id;
    INSERT INTO option (id_question, content, feedback, correct) VALUES (last_question_id, 'Carnivorous', '¡Muy bien! El lagarto es carnívoro.', TRUE);
    INSERT INTO option (id_question, content, feedback, correct) VALUES (last_question_id, 'Herbivorous', '¡Uy!, no es correcto. El lagarto es carnívoro, no herbívoro.', FALSE);
    INSERT INTO option (id_question, content, feedback, correct) VALUES (last_question_id, 'Omnivorous', '¡Uy!, no es correcto. El lagarto es carnívoro, no omnívoro.', FALSE);
    
    INSERT INTO question_group (id_task_stage, id_team_name) VALUES (8, 3) RETURNING id_question_group INTO last_question_group_id;
    
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 1, 'Where do alligators live?', NULL, NULL, 'select', 'Imagen de un caimán en un río', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/alligator_river_1.jpg', NULL, NULL, 'La imagen muestra un caimán en un río.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 2, 'What''s the alligator''s name?', NULL, NULL, 'select', 'Imagen de un caimán llamado Aldo', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/alligator_1.jpg', NULL, NULL, 'La imagen muestra un caimán llamado Aldo.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 3, 'How old is the alligator?', NULL, NULL, 'select', 'Imagen de un caimán de 5 años', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/alligator_5yo_1.jpg', NULL, NULL, 'La imagen muestra un caimán de 5 años.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 4, 'Select the body part of the alligator', NULL, NULL, 'select', 'Imagen de las garras de un caimán', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/alligator_claws_1.jpg', NULL, NULL, 'La imagen muestra las garras de un caimán.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 5, 'Select the skill of the alligator', NULL, NULL, 'select', 'Imagen de un caimán escondiéndose', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/alligator_hide_1.jpg', NULL, NULL, 'La imagen muestra un caimán escondiéndose.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 6, 'Select the diet of the alligator', NULL, NULL, 'select', 'Imagen de un caimán comiendo', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/alligator_eat_1.jpg', NULL, NULL, 'La imagen muestra un caimán comiendo.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question_group (id_task_stage, id_team_name) VALUES (8, 4) RETURNING id_question_group INTO last_question_group_id;
    
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 1, 'Where do manatees live?', NULL, NULL, 'select', 'Imagen de un manatí en un océano', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/manatee_ocean_1.jpg', NULL, NULL, 'La imagen muestra un manatí en un océano.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 2, 'What''s the manatee''s name?', NULL, NULL, 'select', 'Imagen de una manatí llamada Molly', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/manatee_1.jpg', NULL, NULL, 'La imagen muestra una manatí llamada Molly.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 3, 'How old is the manatee?', NULL, NULL, 'select', 'Imagen de un manatí de 15 años', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/manatee_15yo_1.jpg', NULL, NULL, 'La imagen muestra un manatí de 15 años.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 4, 'Select the body part of the manatee', NULL, NULL, 'select', 'Imagen de los dientes de un manatí', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/manatee_teeth_1.jpg', NULL, NULL, 'La imagen muestra los dientes de un manatí.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 5, 'Select the skill of the manatee', NULL, NULL, 'select', 'Imagen de un manatí nadando', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/manatee_swim_1.jpg', NULL, NULL, 'La imagen muestra un manatí nadando.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 6, 'Select the diet of the manatee', NULL, NULL, 'select', 'Imagen de un manatí comiendo', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/manatee_eat_1.jpg', NULL, NULL, 'La imagen muestra un manatí comiendo.') RETURNING id_question INTO last_question_id;
    ...
    -- INSERT INTO question_group (id_task_stage, id_team_name) VALUES (8, 5) RETURNING id_question_group INTO last_question_group_id;
    
    
    -- INSERT INTO question_group (id_task_stage, id_team_name) VALUES (8, 6) RETURNING id_question_group INTO last_question_group_id;
    
    
    -- INSERT INTO question_group (id_task_stage, id_team_name) VALUES (8, 7) RETURNING id_question_group INTO last_question_group_id;
    
    
    -- INSERT INTO question_group (id_task_stage, id_team_name) VALUES (8, 8) RETURNING id_question_group INTO last_question_group_id;
    
    
    -- INSERT INTO question_group (id_task_stage, id_team_name) VALUES (8, 9) RETURNING id_question_group INTO last_question_group_id;
    
    
    -- INSERT INTO question_group (id_task_stage, id_team_name) VALUES (8, 10) RETURNING id_question_group INTO last_question_group_id;
    
    
    -- INSERT INTO question_group (id_task_stage, id_team_name) VALUES (8, 11) RETURNING id_question_group INTO last_question_group_id;
    
    
    -- postask 3
    INSERT INTO question_group (id_task_stage) VALUES (9) RETURNING id_question_group INTO last_question_group_id;

    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 1, 'Missing Osprey. An Osprey is lost. His _ is Otto', NULL, NULL, 'fill', 'Imagen de águila pescadora perdida', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/osprey_lost_1.jpg', NULL, NULL, 'La imagen muestra un águila pescadora perdida.') RETURNING id_question INTO last_question_id;
    INSERT INTO option (id_question, content, feedback, correct) VALUES (last_question_id, 'Otto', '¡Excelente! "Otto" es la respuesta correcta.', TRUE);
    INSERT INTO option (id_question, content, feedback, correct) VALUES (last_question_id, 'Molly', 'Incorrecto.".', FALSE);
    INSERT INTO option (id_question, content, feedback, correct) VALUES (last_question_id, 'Lina', 'Incorrecto.', FALSE);
    
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 2, 'He is 7 years old. He lives in a _', NULL, NULL, 'fill', 'Imagen de águila pescadora en un manglar', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/osprey_lost_1.jpg', NULL, NULL, 'La imagen muestra un águila pescadora en un manglar.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 3, 'He has brown and white wings, so he can _ and hunt fish. Is he carnivourous? Yes!', NULL, NULL, 'fill', 'Imagen de águila pescadora', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/osprey_lost_1.jpg', NULL, NULL, 'La imagen muestra un águila pescadora.') RETURNING id_question INTO last_question_id;
