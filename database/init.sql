...
BEGIN
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 2, 'What''s the osprey''s name?', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/osprey_1.mp3', NULL, 'select', 'Imagen de un águila pescadora llamada Otto', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/osprey_1.jpg', NULL, NULL, 'La imagen muestra un águila pescadora llamada Otto.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 3, 'How old is the osprey?', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/osprey_1.mp3', NULL, 'select', 'Imagen de un águila pescadora de 7 años', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/osprey_7yo_1.jpg', NULL, NULL, 'La imagen muestra un águila pescadora de 7 años.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 4, 'Select the body part of the osprey', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/osprey_1.mp3', NULL, 'select', 'Imagen del ala de un águila pescadora', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/osprey_wing_1.jpg', NULL, NULL, 'La imagen muestra el ala de un águila pescadora.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 5, 'Select the skill of the osprey', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/osprey_1.mp3', NULL, 'select', 'Imagen de un águila pescadora volando', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/osprey_fly_1.jpg', NULL, NULL, 'La imagen muestra un águila pescadora volando.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 6, 'Select the diet of the osprey', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/osprey_1.mp3', NULL, 'select', 'Imagen de un águila pescadora pescando', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/osprey_fish_1.jpg', NULL, NULL, 'La imagen muestra un águila pescadora pescando.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 2, 'What''s the lizard''s name?', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/lizard_1.mp3', NULL, 'select', 'Imagen de una lagarto llamada Lina', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/lizard_1.jpg', NULL, NULL, 'La imagen muestra una lagarto llamada Lina.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 3, 'How old is the lizard?', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/lizard_1.mp3', NULL, 'select', 'Imagen de un lagarto de 11 años', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/lizard_11yo_1.jpg', NULL, NULL, 'La imagen muestra un lagarto de 11 años.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 4, 'Select the body part of the lizard', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/lizard_1.mp3', NULL, 'select', 'Imagen de la cola de un lagarto', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/lizard_tail_1.jpg', NULL, NULL, 'La imagen muestra la cola de un lagarto.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 5, 'Select the skill of the lizard', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/lizard_1.mp3', NULL, 'select', 'Imagen de un lagarto corriendo', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/lizard_run_1.jpg', NULL, NULL, 'La imagen muestra un lagarto corriendo.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 6, 'Select the diet of the lizard', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/lizard_1.mp3', NULL, 'select', 'Imagen de un lagarto comiendo', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/lizard_eat_1.jpg', NULL, NULL, 'La imagen muestra un lagarto comiendo.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 2, 'What''s the alligator''s name?', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/alligator_1.mp3', NULL, 'select', 'Imagen de un caimán llamado Aldo', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/alligator_1.jpg', NULL, NULL, 'La imagen muestra un caimán llamado Aldo.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 3, 'How old is the alligator?', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/alligator_1.mp3', NULL, 'select', 'Imagen de un caimán de 5 años', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/alligator_5yo_1.jpg', NULL, NULL, 'La imagen muestra un caimán de 5 años.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 4, 'Select the body part of the alligator', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/alligator_1.mp3', NULL, 'select', 'Imagen de las garras de un caimán', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/alligator_claws_1.jpg', NULL, NULL, 'La imagen muestra las garras de un caimán.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 5, 'Select the skill of the alligator', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/alligator_1.mp3', NULL, 'select', 'Imagen de un caimán escondiéndose', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/alligator_hide_1.jpg', NULL, NULL, 'La imagen muestra un caimán escondiéndose.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 6, 'Select the diet of the alligator', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/alligator_1.mp3', NULL, 'select', 'Imagen de un caimán comiendo', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/alligator_eat_1.jpg', NULL, NULL, 'La imagen muestra un caimán comiendo.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 2, 'What''s the manatee''s name?', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/manatee_1.mp3', NULL, 'select', 'Imagen de una manatí llamada Molly', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/manatee_1.jpg', NULL, NULL, 'La imagen muestra una manatí llamada Molly.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 3, 'How old is the manatee?', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/manatee_1.mp3', NULL, 'select', 'Imagen de un manatí de 15 años', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/manatee_15yo_1.jpg', NULL, NULL, 'La imagen muestra un manatí de 15 años.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 4, 'Select the body part of the manatee', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/manatee_1.mp3', NULL, 'select', 'Imagen de los dientes de un manatí', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/manatee_teeth_1.jpg', NULL, NULL, 'La imagen muestra los dientes de un manatí.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 5, 'Select the skill of the manatee', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/manatee_1.mp3', NULL, 'select', 'Imagen de un manatí nadando', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/manatee_swim_1.jpg', NULL, NULL, 'La imagen muestra un manatí nadando.') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint) VALUES (last_question_group_id, 6, 'Select the diet of the manatee', 'https://storage.googleapis.com/eyeland-0/app/content/task_2/audio/manatee_1.mp3', NULL, 'select', 'Imagen de un manatí comiendo', 'https://storage.googleapis.com/eyeland-0/app/content/task_3/manatee_eat_1.jpg', NULL, NULL, 'La imagen muestra un manatí comiendo.') RETURNING id_question INTO last_question_id;
