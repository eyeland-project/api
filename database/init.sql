...
BEGIN
    ...
    INSERT INTO question (id_task_stage, id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint, lang) VALUES (13, NULL, 5, 'What types of animals are there in the mangroves?', NULL, NULL, 'select', 'Imagen de pelícanos pardos en un manglar', 'https://storage.googleapis.com/eyeland-0/app/content/task_5/pelican_mangrove_1.jpg', 'vocabulary', NULL, 'La imagen muestra pelícanos pardos en un manglar.', 'en') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_task_stage, id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint, lang) VALUES (13, NULL, 6, 'What types of animals are there in the ocean?', NULL, NULL, 'select', 'Imagen de un róbalo en el océano', 'https://storage.googleapis.com/eyeland-0/app/content/task_5/sea_bass_ocean_1.jpg', 'vocabulary', NULL, 'La imagen muestra un róbalo en el océano.', 'en') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO question (id_task_stage, id_question_group, question_order, content, audio_url, video_url, type, img_alt, img_url, topic, character, hint, lang) VALUES (13, NULL, 8, 'What types of animals are there in the river?', NULL, NULL, 'select', 'Imagen de un pato negro en un río', 'https://storage.googleapis.com/eyeland-0/app/content/task_5/duck_river_1.jpg', 'vocabulary', NULL, 'La imagen muestra un pato negro en un río.', 'en') RETURNING id_question INTO last_question_id;
    ...
    INSERT INTO option (id_question, content, feedback, correct, main_img_alt, main_img_url, preview_img_alt, preview_img_url) VALUES (last_question_id, 'Seagrass', 'Incorrecto.', FALSE, 'Imagen de pastos marinos', NULL, 'Imagen de pastos marinos', 'https://storage.googleapis.com/eyeland-0/app/content/task_5/seagrasses_prev_1.jpg');
...
-- INSERT INTO release
INSERT INTO release (url, version) VALUES ('https://storage.googleapis.com/eyeland-0/app/dist/v/eyeland-3.5.12.apk', '3.5.12');
